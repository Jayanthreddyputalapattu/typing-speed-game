...
words = ['mango','apple',"gun",'fun','door','too','jayanth','gayathri','tv','mobile','laptop','fan','people','good','super','bye','hi','bad','chrome','google','yahoo','firefox','safari','go','come','here','there','lego','best','waste','csk','mental dc','mi','india','cricket','mental rr','srh']
